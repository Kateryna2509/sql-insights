...
**Висновок:** тут три різні CTE (гроші, люди, трафік) з'єднуються разом через LEFT JOIN. Так можна побачити, наприклад, континент, де сесій багато, а грошей мало — тобто проблема не в трафіку, а в тому, що люди не купують.
